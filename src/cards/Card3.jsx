...
const Card3 = () => {
    return (
        ...
        <>
            <section className='w-90 h-60 justify-center flex flex-col px-4 space-y-9 bg-[#181818] rounded-[11px]  
           group
             backdrop-blur-md
        shadow-xl
        ...
        hover:scale-105'>
                <h1 className='flex  justify-between text-black'>
                    <span className='bg-[#5B5B5B] w-40 py-2 rounded-full flex justify-center items-center transition-colors duration-300
            group-hover:bg-[#95F709]'> Applied Fitness</span>
            ...
            group-hover:bg-[#95F709]'><GoArrowUpRight /></span>
                ...
                <h1 className='flex flex-col bg-[#303030] px-4 py-2 rounded-[11px]  transition-colors duration-300
